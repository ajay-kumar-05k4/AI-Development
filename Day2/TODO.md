# EDA on MBA Admissions Dataset

- [x] Import necessary libraries (pandas, numpy, matplotlib, seaborn)
- [x] Load the MBA.csv data
- [x] Display basic info: shape, data types, summary statistics
- [x] Check for missing values
- [x] Visualize distributions: histograms for numerical variables
